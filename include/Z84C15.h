...
#ifndef __Z84C15_included
#define __Z84C15_included

#define CTC_CH0			(*(volatile unsigned char __EXTIO *)0x10)	//!< The CTC chanal 0 for eZ84C15.
#define CTC_CH1			(*(volatile unsigned char __EXTIO *)0x11)	//!< The CTC chanal 1 for eZ84C15.
#define CTC_CH2			(*(volatile unsigned char __EXTIO *)0x12)	//!< The CTC chanal 2 for eZ84C15.
#define CTC_CH3			(*(volatile unsigned char __EXTIO *)0x13)	//!< The CTC chanal 3 for eZ84C15.
#define CTC_CH0_INTADR	(*(volatile unsigned char __EXTIO *)0x10)	//!< The CTC chanal 0 Interrupt Register for eZ84C15.
...
#ifdef _Z84C15_SIO
#define SIOA_DATA		(*(volatile unsigned char __EXTIO *)0x18)	//!< The SIO A Data for eZ84C15.
#define SIOA_COM		(*(volatile unsigned char __EXTIO *)0x19)	//!< The SIO A Command for eZ84C15.
...
#define WATCH_DOG_MODE	(*(volatile unsigned char __EXTIO *)0xF0)	//!< The Watch Dog Timer Stand-by mode Register for eZ84C15.
#define WATCH_DOG_COM	(*(volatile unsigned char __EXTIO *)0xF1)	//!< The Watch Dog Timer Command Register for eZ84C15.

#define DAISY_CHAINE	(*(volatile unsigned char __EXTIO *)0xF4)	//!< The Daisy-chaine interrupt precedence Register for eZ84C15.			
